...
for ds_name, id, source in clf_datasets:
    ...
    import numpy as np
    fig, ax = plt.subplots()
    data = list([scores['vanilla'], scores['hs'], scores['hs_entropy'], scores['hs_entropy_2'], scores['hs_log_cardinality']])
    # basic plot
    ...
    ax.set_xlabel('')
    ax.set_ylabel(sc)
    xticklabels=['vanilla','hs', 'hs_entropy', 'hs_entropy_2', 'hs_log_cardinality']
